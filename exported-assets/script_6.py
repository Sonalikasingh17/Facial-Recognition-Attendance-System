# Create utility modules - fixing indentation
...
print("Configuration Module (utils/config.py) created successfully!")
print("File size:", len(config_py_code), "characters")
print("\nHelpers Module (utils/helpers.py) created successfully!")
print("File size:", len(helpers_py_code), "characters")